...
3. Analyze the codebase to gather the information needed to fill in the three context files.
...
7. Report what was created and what was populated.
...
2. Fill in the "requiring manual review" items above.
3. Commit `.sdlc/` to version control.
4. Run `/update-sdlc-templates` after pulling new versions of dot-claude to keep templates current.
```
