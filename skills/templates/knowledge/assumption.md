...
<State the assumption in one or two sentences. Be specific about scope.>
...
<Populated by `/review-assumption` when the assumption is validated, invalidated, or deferred.>
