...
- `.sdlc/features/<feature>/tasks.md`, or a task decomposition document provided in context or as a file path
- `.sdlc/features/<feature>/plan.md` (optional, improves completeness check)

## Steps

1. Read the task decomposition. If reading from `.sdlc/features/<feature>/tasks.md`, update `status: draft` → `status: in-review` in the frontmatter before proceeding.
